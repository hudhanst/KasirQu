    ...
    render() {
        ...
        return (
            <Fragment>
                {(data && data.length > 0) ? (
                    <Fragment>
                        <Table id='table_outcomereport_barang'>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell style={{ width: '10%' }} align="center" onClick={() => this.ButtonShortSTR(5)}>Total Modal&nbsp;(Rp)</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                {data.map((item, index) => (
...
const mapStateToProps = (state) => ({
    ...
    OutcomeReportBarangList: state.Help.OutcomeReportBarangList,
})
